...
public class VisionCreateRequest : IModelValidate, IOpenAiModels.ITemperature, IOpenAiModels.IModel, IOpenAiModels.IUser
{
    ...
    /// <summary>
    ///     The messages to generate Vision chat completions for, in the chat format.
    ///     The main input is the messages parameter. Messages must be an array of vision message objects, where each object has a
    ...
    ///     Streaming output is supported only with cohices number n = 1 
    /// </summary>
