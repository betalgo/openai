...
public class ChatMessage
{
    ...
    public ChatMessage(ChatMessageRoleEnum role, string content, string? name = null, IList<ToolCall>? toolCalls = null, string? toolCallId = null)
    {
        Role = role;
        Content = content;
        Name = name;
    ...
    /// <param name="toolCallId">The tool function call id generated by the model</param>
    /// <param name="toolCalls">The tool calls generated by the model.</param>
    public ChatMessage(ChatMessageRoleEnum role, IList<MessageContent> contents, string? name = null, IList<ToolCall>? toolCalls = null, string? toolCallId = null)
    {
        Role = role;
        Contents = contents;
        Name = name;
    ...
    public ChatMessageRoleEnum? Role { get; set; }
    ...
    {
        return new(ChatMessageRoleEnum.Assistant, content, name, toolCalls);
    }

    public static ChatMessage FromTool(string content, string toolCallId)
    {
        return new(ChatMessageRoleEnum.Tool, content, toolCallId: toolCallId);
    }

    public static ChatMessage FromUser(string content, string? name = null)
    {
        return new(ChatMessageRoleEnum.User, content, name);
    }

    public static ChatMessage FromSystem(string content, string? name = null)
    {
        return new(ChatMessageRoleEnum.System, content, name);
    }

    public static ChatMessage FromUser(IList<MessageContent> contents)
    {
        return new(ChatMessageRoleEnum.User, contents);
    }
}