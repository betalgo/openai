...
public readonly struct AnnotationType(string value) : IEquatable<AnnotationType>
{
    ...
    public bool Equals(AnnotationType other) => string.Equals(Value, other.Value, StringComparison.OrdinalIgnoreCase);
    ...
    {
        public override AnnotationType Read(ref Utf8JsonReader reader, Type t, JsonSerializerOptions o) => new(reader.GetString()!);
        public override void Write(Utf8JsonWriter writer, AnnotationType value, JsonSerializerOptions o) => writer.WriteStringValue(value.Value);
    }
}