...
public readonly struct MessageContentType(string value) : IEquatable<MessageContentType>
{
    ...
    public bool Equals(MessageContentType other) => string.Equals(Value, other.Value, StringComparison.OrdinalIgnoreCase);
    ...
    {
        public override MessageContentType Read(ref Utf8JsonReader reader, Type t, JsonSerializerOptions o) => new(reader.GetString()!);
        public override void Write(Utf8JsonWriter writer, MessageContentType value, JsonSerializerOptions o) => writer.WriteStringValue(value.Value);
    }
}