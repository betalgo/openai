...
public readonly struct AssistantMessageRole(string value) : IEquatable<AssistantMessageRole>
{
    ...
    public bool Equals(AssistantMessageRole other) => string.Equals(Value, other.Value, StringComparison.OrdinalIgnoreCase);
    ...
    {
        public override AssistantMessageRole Read(ref Utf8JsonReader reader, Type t, JsonSerializerOptions o) => new(reader.GetString()!);
        public override void Write(Utf8JsonWriter writer, AssistantMessageRole value, JsonSerializerOptions o) => writer.WriteStringValue(value.Value);
    }
}
