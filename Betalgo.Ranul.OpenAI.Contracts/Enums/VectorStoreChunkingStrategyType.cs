...
public readonly struct VectorStoreChunkingStrategyType(string value) : IEquatable<VectorStoreChunkingStrategyType>
{
    ...
    public bool Equals(VectorStoreChunkingStrategyType other) =>
    ...
    {
        public override VectorStoreChunkingStrategyType Read(ref Utf8JsonReader reader, Type t, JsonSerializerOptions o) =>
            new(reader.GetString()!);

        public override void Write(Utf8JsonWriter writer, VectorStoreChunkingStrategyType value, JsonSerializerOptions o) =>
