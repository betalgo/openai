...
public readonly struct CreateSpeechResponseFormat(string value) : IEquatable<CreateSpeechResponseFormat>
{
    ...
    public bool Equals(CreateSpeechResponseFormat other) =>
    ...
    {
        public override CreateSpeechResponseFormat Read(ref Utf8JsonReader reader, Type t, JsonSerializerOptions o) =>
            new(reader.GetString()!);

        public override void Write(Utf8JsonWriter writer, CreateSpeechResponseFormat value, JsonSerializerOptions o) =>
