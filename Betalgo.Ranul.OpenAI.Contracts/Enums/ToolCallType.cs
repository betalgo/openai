...
public readonly struct ToolCallType(string value) : IEquatable<ToolCallType>
{
    ...
    public bool Equals(ToolCallType other) => string.Equals(Value, other.Value, StringComparison.OrdinalIgnoreCase);
    ...
    {
        public override ToolCallType Read(ref Utf8JsonReader reader, Type t, JsonSerializerOptions o) => new(reader.GetString()!);
        public override void Write(Utf8JsonWriter writer, ToolCallType value, JsonSerializerOptions o) => writer.WriteStringValue(value.Value);
    }
}