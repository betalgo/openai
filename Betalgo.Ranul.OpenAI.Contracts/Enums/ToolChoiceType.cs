...
public readonly struct ToolChoiceType(string value) : IEquatable<ToolChoiceType>
{
    ...
    {
        public override ToolChoiceType Read(ref Utf8JsonReader reader, Type t, JsonSerializerOptions o) =>
            new(reader.GetString()!);

        public override void Write(Utf8JsonWriter writer, ToolChoiceType value, JsonSerializerOptions o) =>
