...
public readonly struct ImageResponseFormat(string value) : IEquatable<ImageResponseFormat>
{
    ...
    {
        public override ImageResponseFormat Read(ref Utf8JsonReader reader, Type t, JsonSerializerOptions o) =>
            new(reader.GetString()!);

        public override void Write(Utf8JsonWriter writer, ImageResponseFormat value, JsonSerializerOptions o) =>
