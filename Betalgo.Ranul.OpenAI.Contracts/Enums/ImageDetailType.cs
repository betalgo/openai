...
public readonly struct ImageDetailType(string value) : IEquatable<ImageDetailType>
{
    ...
    public bool Equals(ImageDetailType other) =>
    ...
    {
        public override ImageDetailType Read(ref Utf8JsonReader reader, Type t, JsonSerializerOptions o) =>
            new(reader.GetString()!);

        public override void Write(Utf8JsonWriter writer, ImageDetailType value, JsonSerializerOptions o) =>
