...
public readonly struct ImageQuality(string value) : IEquatable<ImageQuality>
{
    ...
    public bool Equals(ImageQuality other) =>
    ...
    {
        public override ImageQuality Read(ref Utf8JsonReader reader, Type t, JsonSerializerOptions o) =>
            new(reader.GetString()!);

        public override void Write(Utf8JsonWriter writer, ImageQuality value, JsonSerializerOptions o) =>
