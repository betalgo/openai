...
public readonly struct ImageFileType(string value) : IEquatable<ImageFileType>
{
    ...
    public bool Equals(ImageFileType other) => string.Equals(Value, other.Value, StringComparison.OrdinalIgnoreCase);
    ...
    {
        public override ImageFileType Read(ref Utf8JsonReader reader, Type t, JsonSerializerOptions o) => new(reader.GetString()!);
        public override void Write(Utf8JsonWriter writer, ImageFileType value, JsonSerializerOptions o) => writer.WriteStringValue(value.Value);
    }
}