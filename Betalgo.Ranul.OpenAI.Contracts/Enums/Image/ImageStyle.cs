...
public readonly struct ImageStyle(string value) : IEquatable<ImageStyle>
{
    ...
    public bool Equals(ImageStyle other) => string.Equals(Value, other.Value, StringComparison.OrdinalIgnoreCase);
    ...
    {
        public override ImageStyle Read(ref Utf8JsonReader reader, Type t, JsonSerializerOptions o) => new(reader.GetString()!);
        public override void Write(Utf8JsonWriter writer, ImageStyle value, JsonSerializerOptions o) => writer.WriteStringValue(value.Value);
    }
}